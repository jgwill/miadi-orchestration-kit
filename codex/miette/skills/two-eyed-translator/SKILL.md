...
description: Rewrites a correct but unreceivable AI output into one a human can act on, holding both eyes on the same object. Use when a reader cannot comprehend an answer's value, the Two-Eyed balance hook blocks, or someone asks to translate, shorten, humanize, or decolonize the last answer.
---

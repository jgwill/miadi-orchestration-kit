...
EXPECTED_COMPANION_FILES = [
    ...
    "claude/miadi-storyweaver-orchestration-kit/README.md",
    "claude/miadi-storyweaver-orchestration-kit/CLAUDE.md",
    "claude/miadi-storyweaver-orchestration-kit/prompts/session-bootstrap.md",
    "claude/miadi-storyweaver-orchestration-kit/prompts/smoke-test.md",
